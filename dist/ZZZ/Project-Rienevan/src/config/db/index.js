...
const MysqlDataSource = new typeorm_1.DataSource({
    ...
    password: "",
    database: "test1",
    entities: [test_entity_1.Test, user_entity_1.User, role_entity_1.Roles, products_entity_1.Products, categories_entity_1.Categories, bills_entity_1.Bills, detail_productsordered_entity_1.DetailsProduct, blog_entity_1.Blog, support_entity_1.FeedBack],
    synchronize: true,
    logging: true,
});
